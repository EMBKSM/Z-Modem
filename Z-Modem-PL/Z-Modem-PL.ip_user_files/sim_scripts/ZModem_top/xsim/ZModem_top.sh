...
#
# Script generated by Vivado on Sun Dec 14 22:33:07 +0900 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ZModem_top.sh
...
#
# Usage        : ZModem_top.sh
#                ZModem_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ZModem_top.sh [-reset_run]
#                ZModem_top.sh [-reset_log]
#                ZModem_top.sh [-help]
#
...
# script info
echo -e "ZModem_top.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ZModem_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L proc_sys_reset_v5_0_17 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ZModem_top xil_defaultlib.ZModem_top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ZModem_top -key {Behavioral:sim_1:Functional:ZModem_top} -tclbatch cmd.tcl -protoinst "protoinst_files/ZModem_top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ZModem_top.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ZModem_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ZModem_top.sh [-help]\n\
Usage: ZModem_top.sh [-step]\n\
Usage: ZModem_top.sh [-lib_map_path]\n\
Usage: ZModem_top.sh [-reset_run]\n\
Usage: ZModem_top.sh [-reset_log]\n\
Usage: ZModem_top.sh [-keep_index]\n\
Usage: ZModem_top.sh [-noclean_files]\n\n\
