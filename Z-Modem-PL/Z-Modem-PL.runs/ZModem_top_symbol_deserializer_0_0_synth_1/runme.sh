...
HD_PWD='C:/work/github/Z-Modem/Z-Modem-PL/Z-Modem-PL.runs/ZModem_top_symbol_deserializer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZModem_top_symbol_deserializer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZModem_top_symbol_deserializer_0_0.tcl
