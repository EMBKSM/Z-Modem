...
HD_PWD='C:/work/github/Z-Modem/Z-Modem-PL/Z-Modem-PL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZModem_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZModem_top_wrapper.tcl -notrace
